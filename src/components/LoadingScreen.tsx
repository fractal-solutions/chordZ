...
export function LoadingScreen() {
  return (
    <div className="fixed inset-0 bg-gray-900 flex flex-col items-center justify-center z-50 overflow-hidden">
      ...
      <h1 className="relative text-7xl font-extrabold text-white mb-2 animate-fade-in-up drop-shadow-lg">VibeChordZ</h1>
      <p className="relative text-white text-lg mb-8 animate-fade-in-delay drop-shadow-md">by Quassa</p>
